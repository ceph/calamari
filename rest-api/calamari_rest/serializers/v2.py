...
class PoolSerializer(ValidatingSerializer):
    ...
    type = fields.EnumField({CRUSH_RULE_TYPE_REPLICATED: 'replicated', CRUSH_RULE_TYPE_ERASURE: 'erasure'}, default='replicated', required=False, help_text="Data redundancy type")
